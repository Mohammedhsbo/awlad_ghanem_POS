...
const API_BASE = normalizeApiBase('http://127.0.0.1:3000/api/v1');
...
export const brands = {
  ...
  create: (data: { nameAr: string; nameEn: string; sortOrder?: number }) => apiFetch<BrandSummary>('/brands', { method: 'POST', body: JSON.stringify(data) }),
  update: (id: string, data: { nameAr?: string; nameEn?: string; isActive?: boolean; sortOrder?: number }) => apiFetch<BrandSummary>(`/brands/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
...
export const categories = {
  ...
  create: (data: { nameAr: string; nameEn: string; parentId?: string; sortOrder?: number }) => apiFetch<CategorySummary>('/categories', { method: 'POST', body: JSON.stringify(data) }),
  update: (id: string, data: { nameAr?: string; nameEn?: string; parentId?: string | null; isActive?: boolean; sortOrder?: number }) => apiFetch<CategorySummary>(`/categories/${id}`, { method: 'PATCH', body: JSON.stringify(data) }),
